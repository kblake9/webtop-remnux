...
RUN export DEBIAN_FRONTEND=noninteractive && \
    ...
    wget -nv -O - https://repo.saltproject.io/py3/ubuntu/20.04/amd64/3005/salt-archive-keyring.gpg | apt-key add - && \
    echo deb [arch=amd64] https://repo.saltproject.io/salt/py3/ubuntu/20.04/amd64/3005 focal main > /etc/apt/sources.list.d/salt.list && \
