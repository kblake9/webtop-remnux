...
RUN export DEBIAN_FRONTEND=noninteractive && \
    ...
    wget -nv -O - https://repo.saltproject.io/salt/py3/ubuntu/20.04/amd64/latest/SALT-PROJECT-GPG-PUBKEY-2023.gpg | apt-key add - && \
    echo deb [arch=amd64] https://repo.saltproject.io/salt/py3/ubuntu/20.04/amd64/latest focal main > /etc/apt/sources.list.d/saltstack.list && \
    apt-get update && \
